...
@interface doSTKQueueEntry : NSObject
{
@public
    OSSpinLock spinLock;
...
@property (readwrite, retain) doSTKDataSource* dataSource;

-(id) initWithDataSource:(doSTKDataSource*)dataSource andQueueItemId:(NSObject*)queueItemId;
